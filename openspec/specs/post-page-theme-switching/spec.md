...
## Purpose
Enable automatic theme switching on post pages based on system preferences, ensuring consistent theme behavior between homepage and post pages. Post pages automatically detect and apply the user's color scheme preference (light or dark mode) and dynamically update when system preferences change.
## Requirements
